...
public class CourseTests {
	...
	void creditsTests() {
		...
		assertSetterUpdatesCurrentValue(course, credits, setCredits, credits.defaultGetter(), 55.0, "credits");
		assertSetterUpdatesCurrentValue(course, credits, setCredits, credits.defaultGetter(), 0.0, "credits");
		...
		// setCredits(negative)
		double invalid = -rand.nextInt(1,100);
